...
router = APIRouter(prefix="/api/admin/users", tags=["Administracion de usuarios"])
...
async def list_users(
    ...
    return auth_service.list_users(role=role.value if role else None, estado=estado, skip=skip, limit=limit)
